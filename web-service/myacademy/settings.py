...
SECRET_KEY = 'django-insecure-_n@axvby^*qpp#z#3n5mc_fbemmz$y(j1wv3g$%%ss5d^jblmx'
...
CORS_ALLOW_ALL_ORIGINS = True # ⬅️ 개발용: 모든 요청 허용
...
DATABASES = {
    'default': {
        ...
        # 'NAME': 'railway',        # MySQL에서 만든 DB 이름
        # 'USER': 'root',                 # MySQL 사용자 이름
        # 'PASSWORD': 'oDtDZgPgLBzPCOXWMiHmIIZpbZSwsntM',    # MySQL 비밀번호
        # 'HOST': 'shortline.proxy.rlwy.net',
        # 'PORT': '28342',                 # MySQL 기본 포트
    }
}
